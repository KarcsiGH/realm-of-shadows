...
## ADDENDUM: SILVER WEAPONS & ANTI-INCORPOREAL

### Silver as Special Material
Silver sits alongside standard material tiers as a special property.
Any weapon type can be made from silver.

```
Silver weapons:
  vs Ghosts/Spirits:     Can deal damage (normal weapons cannot)
  vs Undead/Vampires:    +25-50% bonus damage
  vs Werewolves:         +50% bonus damage
  vs Normal enemies:     -10% damage (silver is softer than steel)
```

Silver weapons are crafted at a forge using silver ore.
Any weapon type can be silver: Silver Dagger, Silver Longsword, etc.
Rangers can craft Silver Arrows for ranged anti-undead capability.

### Temporary Solutions

**Silvering Potion (Mage field craft):**
- Coats a weapon's surface with magical silver
- Duration: One combat
- Effect: Weapon can HIT incorporeal/undead at normal damage
- No bonus damage — just enables hitting
- Applied before combat, does not cost a combat action
- Cost: INT-MP + silver dust + alchemical reagent

**Bless Weapon (Cleric spell):**
- Imbues weapon with Divine energy
- Duration: One combat
- Effect: Weapon can HIT incorporeal/undead PLUS bonus Divine damage
- Strictly better than silvering but costs Cleric's turn and PIE-MP
- Cast during combat on ally's weapon
- Cost: PIE-MP

### Tactical Implications
- Party entering undead area: Mage brews Silvering Potions beforehand
- In combat: Cleric can Bless Weapon for extra Divine damage on top
- Both can be used together (silvered + blessed = normal hit + Divine bonus)
- Rangers with Silver Arrows provide ranged anti-undead without magic
- Parties without Mage or Cleric need permanent silver weapons
