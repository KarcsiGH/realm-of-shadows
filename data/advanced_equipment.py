...
FIGHTER_WEAPONS = [
    ...
    _w("Forgemaster's Blade", "Greatsword", 35, "slashing", {"STR": 3},
       560, "rare", "Crafted by a master smith. The balance is perfect. +3 STR.",
       crit_mod=8,
       damage_stat={"STR": 0.4, "DEX": 0.1}),
    _w("Dawnbreaker Axe", "Greataxe", 38, "slashing", {"STR": 3, "CON": 1},
       600, "rare", "An axe so heavy only the strongest can wield it well. +3 STR, +1 CON.",
    ...
    _w("Aldenmere Greatsword", "Greatsword", 48, "slashing", {"STR": 4, "CON": 2},
       1750, "epic", "A royal-issue greatsword used by imperial guard captains. +4 STR, +2 CON.",
       crit_mod=10, enchant_element="fire", enchant_bonus=5, enchant_name="Flame",
       damage_stat={"STR": 0.4, "DEX": 0.1}),
    _w("Voidcleaver", "Greataxe", 51, "slashing", {"STR": 5},
       1920, "epic", "An axe said to cut the shadow itself. +5 STR. Shadow damage.",
    ...
    _w("Knight's Broadsword","Broadsword", 34, "slashing", {"STR": 3, "DEX": 1},
       520, "rare",    "A broadsword fit for a knight — heavy and authoritative. +3 STR, +1 DEX.",
       enchant_element="blunt", enchant_bonus=2, enchant_name="Weighty",
       damage_stat={"STR": 0.32, "DEX": 0.08}),
    _w("Kingsblade",         "Broadsword", 42, "slashing", {"STR": 4, "DEX": 2},
       1680, "epic",    "A royal broadsword of legendary make. +4 STR, +2 DEX.",
    ...
    _w("War Longsword",      "Longsword", 28, "slashing", {"STR": 2, "DEX": 2},
       480, "rare",    "A battle-tested longsword. Long reach, high precision. +2 STR, +2 DEX.",
       accuracy_mod=6, damage_stat={"STR": 0.28, "DEX": 0.14}),
    _w("Dawnbreaker",        "Longsword", 38, "slashing", {"STR": 3, "DEX": 3},
       1610, "epic",    "A longsword that catches morning light in its steel. +3 STR, +3 DEX.",
    ...
    _w("Champion's Glaive",  "Glaive", 38, "slashing", {"STR": 4, "CON": 2},
       760, "rare",    "A war glaive bearing the crest of a champion. +4 STR, +2 CON.",
       enchant_element="slashing", enchant_bonus=4, enchant_name="Razored",
       damage_stat={"STR": 0.40}),
    _w("Dragonhewn Glaive",  "Glaive", 50, "slashing", {"STR": 5, "CON": 2},
       1920, "epic",    "Said to have split a dragon's scale. +5 STR, +2 CON.",
    ...
    _w("Knight's Lance",     "Lance", 36, "piercing", {"STR": 3, "CON": 1},
       600, "rare",    "A heavy jousting lance reinforced for war. +3 STR, +1 CON.",
    ...
    _w("Titan's Maul",       "Warhammer", 45, "blunt", {"STR": 5, "CON": 3},
       1820, "epic",    "A maul forged for a giant. Barely wielded by mortals. +5 STR, +3 CON.",
    ...
    _w("Champion's Axe",     "Axe",  32, "slashing", {"STR": 4, "CON": 1},
       600, "rare",    "A broad-headed axe, balanced for war. +4 STR, +1 CON.",
       damage_stat={"STR": 0.40}),
    ...
    _w("Blessed Mace",       "Mace", 30, "blunt", {"STR": 3, "PIE": 1},
       500, "rare",    "A mace consecrated by the temple. Bonus vs undead. +3 STR, +1 PIE.",
    ...
    _w("Titan's Mace",       "Mace", 42, "blunt", {"STR": 5, "CON": 2},
       1720, "epic",    "A mace of legendary weight. Dents armour on contact. +5 STR, +2 CON.",
...
FIGHTER_ARMOR = [
    ...
    # T3
    _a("Platemail Hauberk", "chest", "body", 16, {"CON": 2, "STR": 1}, 500, "rare",
       "Heavy plate covering torso and shoulders. +2 CON, +1 STR.",
       speed_mod=-1),
    _a("Warlord's Helm", "helmet", "head", 10, {"CON": 3}, 440, "rare",
       "Imposing full helm with cheek guards. +3 CON.",
       magic_resist=4),
    _a("Vanguard Greaves", "boots", "feet", 7, {"CON": 2}, 360, "rare",
       "Heavy leg armor — painful to the knees but worth it. +2 CON.",
       speed_mod=-1),

    # T4
    _a("Imperial Full Plate", "chest", "body", 22, {"CON": 4, "STR": 2}, 1580, "epic",
       "The finest plate armor money can buy. +4 CON, +2 STR.",
       magic_resist=6, speed_mod=-2),
    _a("Crown Guard Helm", "helmet", "head", 14, {"CON": 3, "STR": 1}, 1330, "epic",
...
FIGHTER_ACCESSORIES = [
    ...
    _acc("Champion's Belt", "ring", "ring1", {"STR": 3, "CON": 2}, 440, "rare",
         "A heavy leather belt reinforced with iron studs. +3 STR, +2 CON."),
    _acc("Ring of the Vanguard", "ring", "ring1", {"STR": 4, "CON": 3}, 1400, "epic",
...
MAGE_WEAPONS = [
    ...
    _w("Runemaster's Staff", "Staff", 16, "blunt", {"INT": 3, "WIS": 1},
       520, "rare", "Covered in layered runes of amplification. +3 INT, +1 WIS.",
    ...
    _w("Archmagus Staff", "Staff", 22, "blunt", {"INT": 5, "WIS": 2},
       1750, "epic", "Said to amplify spells beyond normal limits. +5 INT, +2 WIS.",
    ...
    _w("Force Rod", "Rod", 20, "blunt", {"INT": 2, "STR": 1},
       360, "rare", "Heavy rod for arcane melee impact. +2 INT, +1 STR.",
       damage_stat={"INT": 0.28, "STR": 0.14}),
    _w("Void Rod", "Rod", 28, "blunt", {"INT": 3, "WIS": 2},
       1330, "epic", "A rod of condensed void energy. +3 INT, +2 WIS.",
    ...
    _w("Eclipse Orb", "Orb", 14, "arcane", {"INT": 2, "WIS": 2},
       400, "rare", "A dark orb that eclipses both mind and nature. +2 INT, +2 WIS.",
       spell_bonus=6, damage_stat={"INT": 0.22, "WIS": 0.18}),
    _w("Infinity Orb", "Orb", 20, "arcane", {"INT": 3, "WIS": 2, "PIE": 1},
       1470, "epic", "A perfect orb containing all schools of magic. +3 INT, +2 WIS, +1 PIE.",
...
MAGE_ACCESSORIES = [
    ...
    _acc("Scholar's Pendant", "amulet", "neck", {"INT": 2, "WIS": 1}, 90, "uncommon",
         ...
         magic_resist=4),
    _acc("Arcanist's Signet", "ring", "ring1", {"INT": 3, "WIS": 2}, 420, "rare",
         "A signet ring that resonates with spell energy. +3 INT, +2 WIS.",
         magic_resist=6),
    _acc("Ring of the Archmage", "ring", "ring1", {"INT": 4, "WIS": 3}, 1470, "epic",
...
CLERIC_WEAPONS = [
    ...
    _w("Grand Scepter", "Scepter", 20, "blunt", {"PIE": 3, "INT": 2},
       400, "rare", "An ornate ceremonial scepter charged with divine will. +3 PIE, +2 INT.",
    ...
    _w("Archpriest's Scepter", "Scepter", 30, "blunt", {"PIE": 4, "WIS": 2, "INT": 2},
       1470, "epic", "The scepter of the highest clergy. Radiates divine authority. +4 PIE, +2 WIS, +2 INT.",
    ...
    _w("Censer of Devotion", "Censer", 18, "blunt", {"PIE": 3, "WIS": 2},
       360, "rare", "A silver censer of sacred resin. +3 PIE, +2 WIS.",
    ...
    _w("Archpriest's Censer", "Censer", 26, "blunt", {"PIE": 4, "WIS": 3},
       1330, "epic", "A golden censer of legendary piety. Fills foes with divine dread. +4 PIE, +3 WIS.",
    ...
    _w("Silver Morning Star", "Morning Star", 22, "blunt", {"STR": 2, "PIE": 2},
       360, "rare", "A silver-spiked morning star. Blessed metal burns undead. +2 STR, +2 PIE.",
    ...
    _w("War Flail", "Flail", 24, "blunt", {"STR": 3, "CON": 1},
       420, "rare", "A battle-hardened flail favoured by crusaders. +3 STR, +1 CON.",
       damage_stat={"STR": 0.40}),
]
...
CLERIC_ACCESSORIES = [
    ...
    _acc("Archpriest's Pendant", "amulet", "neck", {"PIE": 3, "WIS": 2}, 400, "rare",
         "Worn by senior clerics who have performed miracles. +3 PIE, +2 WIS.",
         magic_resist=8),
    _acc("Divine Signet", "ring", "ring1", {"PIE": 4, "WIS": 3}, 1400, "epic",
...
THIEF_WEAPONS = [
    ...
    _w("Assassin's Blade", "Dagger", 22, "piercing", {"DEX": 3, "INT": 1},
       480, "rare", "A blade used by contract killers. +3 DEX, +1 INT.",
    ...
    _w("Twin Fang Daggers", "Dagger", 21, "piercing", {"DEX": 3},
       520, "rare", "Matched pair — one in each hand. +3 DEX.",
       crit_mod=18, special="dual_wield",
       damage_stat={"DEX": 0.4}),
    _w("Guild Recurve", "Crossbow", 26, "piercing", {"DEX": 2},
       500, "rare", "A masterwork crossbow from the Thieves' Guild armoury. +2 DEX.",
       range_="ranged", accuracy_mod=12, crit_mod=15,
       damage_stat={"DEX": 0.28, "STR": 0.12}),

    # T4
    _w("Shadowfang", "Dagger", 30, "piercing", {"DEX": 5},
       1680, "epic", "A blade that seems to cut from within shadows. +5 DEX.",
    ...
    _w("Guildmaster's Rapier", "Short Sword", 26, "piercing", {"DEX": 4, "INT": 2},
       1750, "epic", "The weapon of a Guildmaster — precise as a surgeon. +4 DEX, +2 INT.",
    ...
    _w("Pirate's Saber",     "Saber", 27, "slashing", {"DEX": 3, "STR": 2},
       480, "rare",    "A legendary saber from the Eastern Sea routes. +3 DEX, +2 STR.",
    ...
    _w("Assassin's Blade",   "Short Sword", 25, "slashing", {"DEX": 3, "INT": 1},
       420, "rare",    "A short sword with a false edge and fullers. +3 DEX, +1 INT.",
...
THIEF_ARMOR = [
    ...
    # T3
    _a("Assassin's Garb", "chest", "body", 10, {"DEX": 3}, 470, "rare",
       "Full leather suit used by contract killers. +3 DEX.", speed_mod=2),
    _a("Shadowweave Hood", "helmet", "head", 4, {"DEX": 2, "INT": 1}, 400, "rare",
       "Woven from shadow-silk — absorbs light. +2 DEX, +1 INT.",
       enchant_element="shadow", enchant_bonus=3, enchant_name="Shadow"),

    # T4
    _a("Phantom Leathers", "chest", "body", 13, {"DEX": 4, "INT": 1}, 1470, "epic",
    ...
    _a("Shadowmaster's Cowl", "helmet", "head", 5, {"DEX": 3, "INT": 2}, 1260, "epic",
...
THIEF_ACCESSORIES = [
    ...
    _acc("Shadow Signet", "ring", "ring1", {"DEX": 3, "INT": 2}, 400, "rare",
         "A ring used to identify senior guild operatives. +3 DEX, +2 INT.",
         enchant_element="shadow", enchant_bonus=3, enchant_name="Shadow"),
    _acc("Ring of the Phantom", "ring", "ring1", {"DEX": 5, "INT": 2}, 1470, "epic",
...
RANGER_WEAPONS = [
    ...
    _w("Composite War Bow", "Longbow", 29, "piercing", {"DEX": 3},
       530, "rare", "A laminated bow with serious draw weight. +3 DEX.",
    ...
    _w("Ranger's Glaive", "Spear", 27, "slashing", {"DEX": 2, "WIS": 2},
       500, "rare", "A bladed spear for mid-range control. +2 DEX, +2 WIS.",
       range_="reach",
       damage_stat={"STR": 0.24, "DEX": 0.16}),
    _w("Beastslayer Bow", "Longbow", 26, "piercing", {"DEX": 2, "STR": 1},
       560, "rare", "Designed for large prey. +2 DEX, +1 STR. Extra damage vs beasts.",
       range_="ranged", special="beast_slayer", crit_mod=8,
       damage_stat={"DEX": 0.35, "STR": 0.08}),

    # T4
    _w("Windwhisper Bow", "Longbow", 38, "piercing", {"DEX": 4, "WIS": 2},
       1750, "epic", "So precise it seems to anticipate the target. +4 DEX, +2 WIS.",
    ...
    _w("Thornwood Lance", "Spear", 35, "piercing", {"DEX": 3, "WIS": 3},
       1680, "epic", "A living spear — the wood grows and repairs itself. +3 DEX, +3 WIS.",
    ...
    _w("Forest Shortbow",    "Shortbow", 19, "piercing", {"DEX": 3, "WIS": 1},
       280, "rare",    "Carved from a single piece of living yew. +3 DEX, +1 WIS.",
    ...
    _w("Hawk's Shortbow",    "Shortbow", 27, "piercing", {"DEX": 4, "WIS": 2},
       1120, "epic",    "A bow of hawk-wing wood that guided every arrow true. +4 DEX, +2 WIS.",
    ...
    _w("Stormwood Longbow",  "Longbow", 36, "piercing", {"DEX": 4, "WIS": 2},
       1400, "epic",    "Heartwood from a storm-struck oak. Lightning-fast release. +4 DEX, +2 WIS.",
    ...
    _w("Warden Javelin",     "Spear", 32, "piercing", {"STR": 3, "DEX": 3, "WIS": 1},
       560, "rare",    "A javelin engraved with old Warden runes. +3 STR, +3 DEX, +1 WIS.",
       range_="ranged", accuracy_mod=8,
    ...
    _w("Stalker's Blade",    "Short Sword", 22, "slashing", {"DEX": 4, "WIS": 2},
       540, "rare",    "A blade that seems to find gaps in armour naturally. +4 DEX, +2 WIS.",
       crit_mod=8, accuracy_mod=6,
    ...
    _w("Siege Crossbow",     "Crossbow", 38, "piercing", {"DEX": 4, "STR": 2},
       760, "rare",    "A crossbow powerful enough to pin a man to a wall. +4 DEX, +2 STR.",
...
RANGER_ARMOR = [
    ...
    # T3
    _a("Verdant Leathers", "chest", "body", 12, {"DEX": 2, "WIS": 2}, 480, "rare",
       "Ranger armor treated with plant oils for camouflage. +2 DEX, +2 WIS.",
       speed_mod=1),
    _a("Huntmaster's Hood", "helmet", "head", 4, {"WIS": 3}, 420, "rare",
       "Worn by the most senior rangers of the order. +3 WIS.", magic_resist=6),

    # T4
    _a("Wildborn Armor", "chest", "body", 16, {"DEX": 3, "WIS": 3}, 1470, "epic",
    ...
    _a("Crown of the Forest", "helmet", "head", 5, {"WIS": 4, "DEX": 1}, 1260, "epic",
...
RANGER_ACCESSORIES = [
    ...
    _acc("Ranger's Signet", "ring", "ring1", {"DEX": 2, "WIS": 3}, 420, "rare",
         "Worn by rangers who have earned their full title. +2 DEX, +3 WIS.",
         magic_resist=5),
    _acc("Ring of the Wild", "ring", "ring1", {"DEX": 3, "WIS": 4}, 1470, "epic",
...
MONK_WEAPONS = [
    ...
    _w("Dragon Bone Staff", "Staff", 32, "blunt", {"WIS": 4, "DEX": 3},
       1780, "epic", "A staff made from the bones of an elder dragon. +4 WIS, +3 DEX.",
    ...
    _w("Temple Nunchaku",    "Kama", 20, "blunt", {"DEX": 3, "WIS": 2},
       310, "rare",    "Sacred nunchaku carved with meditative scripture. +3 DEX, +2 WIS.",
    ...
    _w("Storm Nunchaku",     "Kama", 30, "blunt", {"DEX": 4, "WIS": 3},
       1220, "epic",    "Nunchaku that blur into a storm of strikes. +4 DEX, +3 WIS.",
    ...
    _w("Jade Tonfa",         "Kama", 24, "blunt", {"STR": 2, "WIS": 3},
       460, "rare",    "Carved jade tonfa — Ki flows through the stone. +2 STR, +3 WIS.",
       spell_bonus=5, damage_stat={"STR": 0.20, "WIS": 0.28}),
    _w("Void Tonfa",         "Kama", 34, "blunt", {"STR": 3, "WIS": 4},
       1400, "epic",    "Tonfa etched with void glyphs. Strikes from unexpected angles. +3 STR, +4 WIS.",
    ...
    _w("Dragon Kama",        "Kama", 35, "slashing", {"DEX": 4, "WIS": 4},
       1540, "epic",    "Twin kama with dragon-tooth blades. +4 DEX, +4 WIS.",
    ...
    _w("Iron-Knuckle Wraps", "Handwraps", 22, "blunt", {"STR": 2, "WIS": 2},
       360, "rare",    "Wraps with iron knuckle plates sewn in. +2 STR, +2 WIS.",
    ...
    _w("Ancestor's Staff",   "Staff", 30, "blunt", {"WIS": 3, "STR": 2},
       580, "rare",    "A staff carved with the faces of revered ancestors. +3 WIS, +2 STR.",
...
MONK_ARMOR = [
    ...
    # T3
    _a("Master's Gi", "robes", "body", 8, {"WIS": 3, "DEX": 1}, 470, "rare",
       "The gi of a fully trained monk. +3 WIS, +1 DEX.", speed_mod=3, magic_resist=8),
    _a("Temple Guardian Band", "helmet", "head", 3, {"WIS": 2, "DEX": 1}, 390, "rare",
       "Worn by monks who guard temples. +2 WIS, +1 DEX.", magic_resist=8),

    # T4
    _a("Transcendence Robes", "robes", "body", 11, {"WIS": 4, "DEX": 2}, 1500, "epic",
    ...
    _a("Mind's Eye Cowl", "helmet", "head", 4, {"WIS": 4}, 1300, "epic",
...
MONK_ACCESSORIES = [
    ...
    _acc("Temple Elder's Pendant", "amulet", "neck", {"WIS": 3, "DEX": 2}, 400, "rare",
         "Given to monks who become elders. +3 WIS, +2 DEX.", magic_resist=6),
    _acc("Ring of Inner Flame", "ring", "ring1", {"WIS": 4, "DEX": 3}, 1470, "epic",
