...
BEAST_ENEMIES = {
    ...
    "Fading Wolf": {
        ...
        "preferred_row": FRONT,
        "ai_type": "aggressive",
        "xp_reward": 42, "gold_reward": _coin(0, 2),
    ...
    "Fading Hound": {
        ...
        "ai_type": "flanker",
        "pack_tactics": True,
        "xp_reward": 33, "gold_reward": _coin(0, 1),
        "resistances": _res(shadow=RESISTANT, nature=VULNERABLE, divine=VULNERABLE),
        "status_immunities": [],
        "abilities": [
    ...
    "Fading Boar": {
        ...
        "preferred_row": FRONT,
        "ai_type": "aggressive",
        "xp_reward": 114, "gold_reward": _coin(0, 2),
    ...
    "Fading Bear": {
        ...
        "preferred_row": FRONT,
        "ai_type": "aggressive",
        "xp_reward": 165, "gold_reward": _coin(0, 3),
    ...
    "Fading Stag": {
        ...
        "preferred_row": FRONT,
        "ai_type": "aggressive",
        "xp_reward": 105, "gold_reward": _coin(0, 2),
...
FALLEN_WARDEN_ENEMIES = {
    ...
    "Warden Shade": {
        ...
        "preferred_row": MID,
        "ai_type": "caster",
        "xp_reward": 416, "gold_reward": _coin(0, 4),
    ...
    "Fallen Warden": {
        ...
        "preferred_row": FRONT,
        "ai_type": "tactical",
        "xp_reward": 576, "gold_reward": _coin(0, 6),
        "resistances": _res(shadow=RESISTANT, divine=VULNERABLE,
        ...
        "loot_table": [
            _drop(0.20, _item("Fallen Warden's Blade","weapon","Long Sword","uncommon",
                ...
                "Shadow enchantment — ward-marks inverted.",175,
    ...
    "Dark Consecrator": {
        ...
        "loot_table": [
            _drop(0.22, _item("Consecration Tome","weapon","Staff","rare",
                7,"blunt","Black Ritual Book","A book whose pages feel wrong.",
                "Tome of Desecration","Former Warden prayer book, inverted.",
                "Shadow enchantment — divine magic turned inside out.",265,
                "A prayer book whose every invocation now calls shadow. +2 PIE, +1 INT.",
                diff=4,
                stat_bonuses={"PIE": 2, "INT": 1},
                spell_bonus=7,
    ...
    "Oathbreaker Knight": {
        ...
        "preferred_row": FRONT,
        "ai_type": "guardian",
        "xp_reward": 950, "gold_reward": _coin(0, 8),
        "resistances": _res(shadow=RESISTANT, divine=VULNERABLE,
                            fire=RESISTANT, ice=RESISTANT,
                            piercing=RESISTANT, slashing=RESISTANT),
        ...
        "loot_table": [
            _drop(0.25, _item("Oathbreaker's Plate","armor","Heavy Armor","rare",
                ...
                "Shadow enchantment — physical resistance, divine weakness.",240,
    ...
    "Shadow Warden": {
        ...
        "preferred_row": BACK,
        "ai_type": "tactical",
        "xp_reward": 880, "gold_reward": _coin(0, 10),
        ...
        "loot_table": [
            _drop(0.30, _item("Shadow Warden Staff","weapon","Staff","rare",
                12,"blunt","Black Staff","A staff that seems to consume light.",
                "Staff of Unmade Wards","Warden channel-staff, shadow-bound.",
                "Shadow enchantment — unravels magical defenses.",290,
                "A staff that channels shadow-corrupted ward-energy. +2 INT, +1 WIS.",
                diff=4,
...
PIRATE_ENEMIES = {
    ...
    "Pirate Deckhand": {
        ...
        "preferred_row": FRONT,
        "ai_type": "aggressive",
        "xp_reward": 224, "gold_reward": _coin(6, 20),
    ...
    "Pirate Markswoman": {
        ...
        "preferred_row": BACK,
        "ai_type": "ranged",
        "xp_reward": 256, "gold_reward": _coin(8, 22),
    ...
    "Pirate Witch Doctor": {
        ...
        "preferred_row": BACK,
        "ai_type": "support",
        "xp_reward": 320, "gold_reward": _coin(10, 28),
        ...
        "loot_table": [
            _drop(0.25, _item("Witch Doctor's Fetish","weapon","Staff","uncommon",
                ...
                "Nature enchantment — amplifies poison.",160,
    ...
    "Pirate First Mate": {
        ...
        "preferred_row": FRONT,
        "ai_type": "tactical",
        "xp_reward": 464, "gold_reward": _coin(22, 55),
        "resistances": _res(lightning=VULNERABLE),
        "status_immunities": [],
        "abilities": [
    ...
    "Pirate Captain": {
        ...
        "preferred_row": FRONT,
        "ai_type": "tactical",
        "xp_reward": 704, "gold_reward": _coin(45, 110),
        "resistances": _res(lightning=VULNERABLE),
        ...
        "loot_table": [
            _drop(0.35, _item("Captain's Plunder Sword","weapon","Long Sword","rare",
                ...
                "No magical properties — but excellently crafted.",275,
                "A naval officer's sword. +2 STR, +1 DEX. Excellently crafted.",
                stat_bonuses={"STR": 2, "DEX": 1},
                accuracy_mod=4)),
    ...
    "Imperial Court Mage": {
        ...
        "loot_table": [
            _drop(0.22, _item("Imperial Mage Staff","weapon","Staff","uncommon",
                ...
                "Arcane enchantment — spell amplification.",200,
    ...
    "Imperial Inquisitor": {
        ...
        "loot_table": [
            ...
            _drop(0.20, _item("Inquisitor's Blade","weapon","Long Sword","uncommon",
                ...
                "Divine enchantment — genuine, not institutional.",185,
    ...
    "Imperial Commander": {
        ...
        "loot_table": [
            _drop(0.30, _item("Commander's Longsword","weapon","Long Sword","rare",
                ...
                "No magical properties — doesn't need any.",280,
                "A commander's sword. +2 STR, +1 CON. This person earned it.",
...
DWARF_ENEMIES = {
    ...
    "Iron Ridge Shade": {
        ...
        "preferred_row": MID,
        "ai_type": "aggressive",
        "xp_reward": 256, "gold_reward": _coin(0, 3),
        "resistances": _res(shadow=RESISTANT, divine=VULNERABLE,
                            piercing=RESISTANT, slashing=RESISTANT),
        "status_immunities": ["Poisoned"],
        "tags": ["undead"],
    ...
    "Vault Automaton": {
        ...
        "preferred_row": FRONT,
        "ai_type": "aggressive",
        "xp_reward": 416, "gold_reward": _coin(0, 0),
    ...
    "Dwarven Forge Guard": {
        ...
        "preferred_row": FRONT,
        "ai_type": "guardian",
        "xp_reward": 496, "gold_reward": _coin(0, 4),
        ...
        "loot_table": [
            _drop(0.25, _item("Forge Guard Hammer","weapon","Mace","uncommon",
                ...
                "Fire resistance enchantment.",185,
    ...
    "Stone Warden Ghost": {
        ...
        "preferred_row": BACK,
        "ai_type": "support",
        "xp_reward": 560, "gold_reward": _coin(0, 5),
