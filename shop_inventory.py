...
TOWN_SHOP_PROFILES = {
    ...
    "sanctum": {
        ...
        "bonus_items": [
            {"name": "Holy Water (Flask)", "type": "consumable", "subtype": "potion",
             ...
             "buy_price": 35, "sell_price": 14, "identified": True},
            {"name": "Panacea", "type": "consumable", "subtype": "potion",
             "rarity": "rare", "cures": ["Poison", "Disease"],
             "description": "A sacred draught blessed by temple healers. Cures all poison and disease.",
    ...
    "thornhaven": {
        ...
        "bonus_items": [
            ...
            {"name": "Panacea", "type": "consumable", "subtype": "potion",
             "rarity": "rare", "cures": ["Poison", "Disease"],
             "description": "An alchemist's masterwork. Instantly cures all poison and disease.",
             "buy_price": 180, "sell_price": 72, "identified": True},
        ],
    },
}
