...
CLASS_ABILITIES = {
    ...
    "Mage": [
        ...
        {"name": "Fireball",         "cost": 20, "resource": "INT-MP", "type": "aoe",
         ...
         "desc": "Explosive fire blast hitting all enemies in a row.", "dot": "burning", "dot_duration": 2},
        ...
        {"name": "Chain Lightning",  "cost": 25, "resource": "INT-MP", "type": "aoe",
         "level": 8, "power": 1.3, "element": "lightning", "desc": "Lightning arcing between all enemies.", "stun_chance": 0.25},
        {"name": "Meteor",           "cost": 40, "resource": "INT-MP", "type": "aoe",
         "level": 12, "power": 1.8, "element": "fire", "desc": "Apocalyptic fire from the sky.", "dot": "burning", "dot_duration": 3},
    ],
    "Cleric": [
    ...
    "Monk": [
        ...
        {"name": "Pressure Point",   "cost": 18, "resource": "Ki", "type": "debuff",
         "level": 8, "status": "Weakened", "status_duration": 3, "status_chance": 0.90, "desc": "Strike nerve clusters. Target deals 30% less damage."},
        {"name": "Dragon Strike",    "cost": 30, "resource": "Ki", "type": "attack",
         "level": 12, "power": 2.8, "element": "fire", "desc": "Channel ki into a devastating fire strike.", "dot": "burning", "dot_duration": 2},
    ],
    ...
    "Warder": [
        {"name": "Crippling Strike",  "cost": 12, "resource": "STR-SP", "type": "attack",
         "level": 1, "power": 1.3, "status": "Weakened", "status_duration": 2, "status_chance": 0.90,
    ...
    "Strider": [
        ...
        {"name": "Hunter's Mark",     "cost": 12, "resource": "DEX-SP", "type": "debuff",
         "level": 1, "status": "Weakened", "status_duration": 3, "status_chance": 0.90,
    ...
    "Inquisitor": [
        ...
        {"name": "Confess",           "cost": 22, "resource": "PIE-MP", "type": "debuff",
         "level": 6, "status": "Weakened", "status_duration": 4, "status_chance": 0.90,
    ...
    "Shadow Master": [
        ...
        {"name": "Death Mark",        "cost": 25, "resource": "DEX-SP", "type": "debuff",
         "level": 2, "status": "Weakened", "status_duration": 5, "status_chance": 0.90,
...
ABILITY_BRANCHES = {
    ...
    "Monk": {
        ...
        7: [
            ...
            {"name": "Pressure Point", "cost": 18, "resource": "Ki", "type": "debuff",
             "level": 7, "status": "Weakened", "status_duration": 3, "status_chance": 0.90,
