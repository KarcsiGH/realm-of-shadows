...
_ENEMY_FILES = {
    ...
    "Bandit Archer":            "Bandit_Crossbowman",   # best-fit
    "Corrupted Treant":         "Fading_Abomination",   # best-fit — large corrupted creature
}
