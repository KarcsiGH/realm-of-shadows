...
class CombatUI:
    ...
    def _draw_left_col(self, surface, mx, my):
        ...
        for row_key in row_order:
            ...
            for p in row_players:
                ...
                sil_w = 44
                sil_h = int(sil_w * 80 / 48)   # correct ratio: ~73px
    ...
    def _resolve_popover_item(self, data, actor):
        ...
        if t == "ability":
            ...
            if ab_type == "passive":
                return None
            # Pierce-row abilities (Splitting Arrow, etc): player picks primary target,
            # the engine's pierce logic hits rows behind the chosen target.
            # Fall through to the standard target-ability flow below.
