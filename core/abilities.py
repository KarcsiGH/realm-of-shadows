...
CLASS_ABILITIES = {
    ...
    "Mage": [
        {"name": "Magic Missile",    "cost": 8,  "resource": "INT-MP", "type": "spell",
         "level": 1, "power": 1.2, "element": "arcane", "auto_hit": True, "desc": "Arcane bolt that never misses."},
        ...
        {"name": "Fireball",         "cost": 18, "resource": "INT-MP", "type": "spell",
         "level": 3, "power": 1.8, "element": "fire", "desc": "Explosive fire blast."},
        ...
        {"name": "Meteor",           "cost": 40, "resource": "INT-MP", "type": "aoe",
         "level": 12, "power": 2.2, "element": "fire", "desc": "Apocalyptic fire from the sky."},
    ],
    "Cleric": [
        {"name": "Heal",             "cost": 10, "resource": "PIE-MP", "type": "heal",
         "level": 1, "power": 1.5, "desc": "Restore HP to one ally."},
