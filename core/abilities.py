...
CLASS_ABILITIES = {
    ...
    "Strider": [
        ...
        {"name": "Blitz",             "cost": 28, "resource": "STR-SP", "type": "aoe",
         "level": 13, "power": 1.1,
         "desc": "Explosive assault across the battlefield. Hits all enemies, bonus damage to lowest-HP target."},
        {"name": "Whirlwind Strike",  "cost": 35, "resource": "STR-SP", "type": "aoe",
         "level": 15, "power": 1.4, "bonus_crit": 15,
         "desc": "Spinning blade storm. Hits all enemies for strong damage with bonus crit chance."},
    ],
    ...
    "Guardian": [
        ...
        {"name": "Ki Shockwave",      "cost": 20, "resource": "Ki", "type": "aoe",
         "level": 11, "power": 1.1, "element": "arcane", "stun_chance": 0.30,
         "desc": "Release a burst of ki force. Hits all enemies — 30% chance to stun each."},
    ...
    "Druid": [
        ...
        {"name": "Lightning Storm",   "cost": 26, "resource": "INT-MP", "type": "aoe",
         "level": 12, "power": 1.4, "element": "lightning", "stun_chance": 0.25,
         "desc": "Call lightning across all enemies. 25% chance to stun each."},
    ...
    "Inquisitor": [
        ...
        {"name": "Smite Shadow",      "cost": 16, "resource": "PIE-MP", "type": "attack",
         ...
         "desc": "Holy-wreathed strike. Deals massive bonus damage to undead, shadow, and corrupted enemies."},
        ...
        {"name": "Judgment Day",      "cost": 40, "resource": "PIE-MP", "type": "aoe",
         "level": 15, "power": 1.8, "element": "divine",
         "desc": "Holy reckoning falls on all enemies. Devastating divine AoE, bonus vs undead and corrupted."},
    ],
    ...
    "Shaman": [
        ...
        {"name": "Earth Pulse",       "cost": 20, "resource": "WIS-MP", "type": "aoe",
         "level": 11, "power": 1.1, "element": "nature", "apply_status": "Slowed",
         "status_duration": 2, "status_chance": 0.60,
         "desc": "Shockwave of earth energy. Hits all enemies and 60% chance to slow each for 2 turns."},
        {"name": "Ancestral Strike",  "cost": 24, "resource": "Ki", "type": "attack",
         "level": 12, "power": 2.4, "element": "nature",
         "desc": "Channel the power of ancestors through one devastating strike. Bypasses magical resistance."},
    ...
    "Necromancer": [
        ...
        {"name": "Death Nova",        "cost": 24, "resource": "INT-MP", "type": "aoe",
         "level": 11, "power": 1.3, "element": "shadow",
         "desc": "Explosion of necrotic energy. Heavy shadow damage to all enemies."},
