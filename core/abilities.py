...
CLASS_ABILITIES = {
    ...
    "Mage": [
        ...
        {"name": "Fireball",       "cost": 20, "resource": "INT-MP", "type": "aoe",
         ...
         "desc": "Explosive fire blast hitting the entire front row.", "dot": "burning", "dot_duration": 2},
        ...
        {"name": "Deep Freeze",    "cost": 18, "resource": "INT-MP", "type": "spell",
         "level": 7, "power": 1.6, "element": "ice", "status": "Frozen", "status_chance": 0.45,
        ...
        {"name": "Chain Lightning", "cost": 25, "resource": "INT-MP", "type": "aoe",
         ...
         "desc": "Lightning arcs between all enemies.", "stun_chance": 0.25},
        ...
        {"name": "Meteor",         "cost": 45, "resource": "INT-MP", "type": "aoe",
         ...
         "desc": "Catastrophic fire strike. Partially affects party's front row — high risk, devastating reward.", "dot": "burning", "dot_duration": 3},
    ],
    ...
    "Cleric": [
        ...
        {"name": "Word of God",     "cost": 40, "resource": "PIE-MP", "type": "aoe",
         "level": 20, "power": 3.0, "element": "divine", "target": "all_enemies", "heal_power": 1.0,
         "desc": "Divine word strikes all enemies. Party heals for damage dealt."},
    ],
    ...
    "Ranger": [
        ...
        {"name": "Splitting Arrow", "cost": 8, "resource": "DEX-SP",   "type": "attack",
         "level": 1, "power": 0.8, "pierce_rows": True,
         "desc": "Arrow pierces the front target and continues to hit the row(s) behind. Reduced damage."},
        ...
        {"name": "Pack Hunt",       "cost": 20, "resource": "WIS-MP",  "type": "buff",
         "level": 15, "buff": "pack_hunt", "duration": 3, "self_only": True,
         "desc": "Call pack spirits to your side. +40% damage and +15% crit chance for 3 turns."},
    ...
    "Monk": [
        ...
        {"name": "Dragon Strike",    "cost": 5, "resource": "momentum", "type": "attack",
         "level": 13, "power": 2.8,
         "desc": "The Monk's signature — a strike of absolute focus.", "dot": "burning", "dot_duration": 2},
    ...
    "Paladin": [
        ...
        {"name": "Sacred Ground",    "cost": 30, "resource": "PIE-MP",  "type": "buff",
         "level": 12, "buff": "sacred_ground", "duration": 3, "targets": "all_allies",
    ...
    "Witch": [
        ...
        {"name": "Mass Sleep",       "cost": 22, "resource": "INT-MP",  "type": "aoe",
    ...
    "Necromancer": [
        ...
        {"name": "Army of the Dead", "cost": 45, "resource": "PIE-MP",  "type": "aoe",
         "level": 20, "power": 2.5, "element": "necrotic", "target": "all_enemies",
         "desc": "Unleash undead hordes against every foe. Massive necrotic damage."},
    ...
    "Druid": [
        ...
        {"name": "Slumber Spore",    "cost": 16, "resource": "WIS-MP",  "type": "aoe",
        ...
        {"name": "Call Lightning",   "cost": 35, "resource": "INT-MP",  "type": "aoe",
         ...
         "desc": "Focused lightning blast. Double damage against wet or frozen targets.", "stun_chance": 0.30},
    ...
    "Mystic": [
        ...
        {"name": "Lullaby",          "cost": 18, "resource": "INT-MP",  "type": "aoe",
        ...
        {"name": "Void Meditation",  "cost": 0,  "resource": "",        "type": "buff",
         "level": 10, "buff": "void_meditation", "duration": 1, "self_only": True,
         "restore_pct": {"MP": 0.4, "Ki": 0.4},
         "desc": "Skip this turn to restore 40% MP and 40% Ki simultaneously."},
    ...
    "Shaman": [
        ...
        {"name": "Totem of the Ages","cost": 35, "resource": "WIS-MP",  "type": "buff",
         "level": 17, "buff": "ancient_totem", "duration": 3, "targets": "all_allies",
         "desc": "Place a powerful totem. Party heals 10% HP per round; enemies deal 20% less damage for 3 rounds."},
        {"name": "Voice of Ancestors","cost": 0, "resource": "",        "type": "revive",
         "level": 20, "revive_hp_pct": 0.5, "targets": "all_allies",
         "desc": "All fallen party members revive at 50% HP."},
    ],
}
# ─────────────────────────────────────────────────────────────────────────────
...
CLASS_ABILITIES["Inquisitor"] = [
    {"name": "Interrogate",     "level": 1,  "type": "debuff",  "cost": 6,  "resource": "DEX-SP", "armor_shred": 4, "slow_duration": 2, "desc": "Weaken enemy defenses through relentless pressure."},
    ...
    {"name": "Shadow Mark",     "level": 3,  "type": "debuff",  "cost": 10, "resource": "DEX-SP", "mark_duration": 3, "mark_crit_bonus": 20, "desc": "Mark a target — all allies deal +20% damage to it for 3 rounds."},
    {"name": "Expose Weakness", "level": 5,  "type": "debuff",  "cost": 12, "resource": "DEX-SP", "armor_shred": 8, "desc": "Shatter armor with precision strikes, reducing enemy defense by 25%."},
    ...
    {"name": "Silence",         "level": 8,  "type": "debuff",  "cost": 16, "resource": "DEX-SP", "status": "Silenced", "status_duration": 3, "status_chance": 0.90, "desc": "Prevent the target from casting spells for 3 rounds."},
...
CLASS_ABILITIES["Warden"] = [
    ...
    {"name": "Nature's Ward",   "level": 2,  "type": "heal",    "cost": 10, "resource": "PIE-MP", "power": 1.2, "desc": "Channel nature's energy to heal a single ally."},
    {"name": "Ancient Seal",    "level": 3,  "type": "debuff",  "cost": 12, "resource": "PIE-MP", "status": "Stunned", "status_duration": 2, "status_chance": 0.80, "desc": "Bind an enemy in place with ancient wards."},
    ...
    {"name": "Verdant Pulse",   "level": 6,  "type": "aoe_heal","cost": 18, "resource": "PIE-MP", "desc": "Release healing energy in a pulse, restoring HP to all allies.", "power": 1.2},
    {"name": "Petrify",         "level": 8,  "type": "debuff",  "cost": 20, "resource": "PIE-MP", "status": "Petrified", "status_duration": 2, "status_chance": 0.85, "desc": "Turn an enemy to stone for 2 rounds — completely incapacitated."},
...
CLASS_ABILITIES["Templar"] = [
    ...
    {"name": "Lay on Hands",    "level": 6,  "type": "heal",    "cost": 16, "resource": "PIE-MP", "power": 3.0, "desc": "Touch an ally to fully restore their HP."},
...
CLASS_ABILITIES["Warder"] = [
    ...
    {"name": "Pressure",        "level": 2,  "type": "debuff",  "cost": 6,  "resource": "DEX-SP", "status": "Slowed", "status_duration": 2, "status_chance": 0.85, "desc": "Relentless pressure that forces an enemy to act last this round."},
    {"name": "Feint",           "level": 3,  "type": "debuff",  "cost": 10, "resource": "DEX-SP", "status": "Confused", "status_duration": 2, "status_chance": 0.85, "desc": "Misdirect the enemy, causing their next attack to miss."},
...
CLASS_ABILITIES["Archmage"] = [
    ...
    {"name": "Time Stop",       "level": 3,  "type": "debuff",  "cost": 25, "resource": "INT-MP", "status": "Stunned", "status_duration": 2, "status_chance": 1.0, "desc": "Freeze a single enemy in time for 2 rounds."},
    {"name": "Meteor",          "level": 5,  "type": "aoe",     "cost": 30, "resource": "INT-MP", "desc": "Call down a devastating meteor, crushing all enemies.", "dot": "burning", "dot_duration": 3},
...
CLASS_ABILITIES["High Priest"] = [
    {"name": "Mass Heal",       "level": 1,  "type": "aoe_heal","cost": 20, "resource": "PIE-MP", "desc": "Restore significant HP to all party members.", "power": 1.5},
    ...
    {"name": "Miracle",         "level": 5,  "type": "heal",    "cost": 30, "resource": "PIE-MP", "power": 4.0, "cures": "any", "desc": "Restore full HP to one ally and cleanse all negative status effects."},
...
CLASS_ABILITIES["Shadow Master"] = [
    ...
    {"name": "Nightmare",       "level": 3,  "type": "debuff",  "cost": 16, "resource": "DEX-SP", "status": "Fear", "status_duration": 2, "status_chance": 0.85, "desc": "Plunge an enemy into terror — they lose their next action."},
    {"name": "Death Mark",      "level": 5,  "type": "debuff",  "cost": 18, "resource": "DEX-SP", "mark_duration": 3, "mark_crit_bonus": 50, "desc": "Mark a target for death — all damage they receive is doubled."},
...
CLASS_ABILITIES["Beastlord"] = [
    {"name": "Primal Roar",     "level": 1,  "type": "debuff",  "cost": 8,  "resource": "DEX-SP", "status": "Fear", "status_duration": 2, "status_chance": 0.75, "desc": "Terrify enemies with a primal roar, reducing their accuracy."},
    ...
    {"name": "Predator's Mark", "level": 5,  "type": "debuff",  "cost": 14, "resource": "DEX-SP", "mark_duration": 3, "mark_crit_bonus": 30, "desc": "Mark prey — deal bonus damage proportional to target's missing HP."},
...
CLASS_ABILITIES["Phantom"] = [
    ...
    {"name": "Haunt",           "level": 3,  "type": "debuff",  "cost": 14, "resource": "DEX-SP", "status": "Confused", "status_duration": 3, "status_chance": 0.80, "desc": "Haunt a target, causing them to miss attacks and act erratically."},
    ...
    "Mage": {
        ...
        7: [
            {"name": "Fireball", "cost": 20, "resource": "INT-MP", "type": "aoe",
             ...
             "branch_desc": "Devastate enemy rows with area explosions.", "dot": "burning", "dot_duration": 2},
            {"name": "Deep Freeze", "cost": 18, "resource": "INT-MP", "type": "spell",
        ...
        10: [
            {"name": "Chain Lightning", "cost": 25, "resource": "INT-MP", "type": "aoe",
             ...
             "branch_desc": "Electrify the battlefield with chain effects.", "stun_chance": 0.25},
            {"name": "Meteor", "cost": 40, "resource": "INT-MP", "type": "aoe",
             ...
             "branch_desc": "Single devastating nuke to end the fight.", "dot": "burning", "dot_duration": 3},
        ],
    },
    ...
    "Monk": {
        ...
        10: [
            {"name": "Dragon Strike", "cost": 5, "resource": "momentum", "type": "attack",
             ...
             "branch_desc": "Unleash elemental power through raw Ki.", "dot": "burning", "dot_duration": 2},
